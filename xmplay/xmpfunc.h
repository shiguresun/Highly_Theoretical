...
// version 4.1
	void (WINAPI *ErrorMessage)(const char *text, const char *caption); // display an error message in main thread
	HWND (WINAPI *GetPopupParent)(); // get parent handle for popup windows/dialogs
} XMPFUNC_MISC;

typedef struct { // config store functions
